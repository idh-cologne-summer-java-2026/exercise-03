...
public class TestLeapYear {
	...
	public void testActualLeapYears() {
		try {
			assertTrue(leapYearObject.isLeapYear(1980)); //ursprünglich "1982", aber das war kein echtes Schaltjahr
	...
	public void testNotLeapYears() {
		try {
			assertFalse(leapYearObject.isLeapYear(1983)); //ursprünglich "assertTrue", aber es soll ja ein "false" asserted werden
